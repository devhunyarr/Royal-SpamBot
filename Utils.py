RAID = [
    "MADARCHOD TU APNE BAAP SE DEV SE LADEGA TERI MAA KA BHOSDA 🤣🤣",
    "MR DEV OP TERI MAA KI CHUTTT ME DEV KI LUND KI TOPI🔥🙈🙈",
    ...
    "TERI MAAA KI FUDDI MR DEV NE FADDI HAI 😂😋😛",
...
RRAID = [
    "MR DEV TERA BAAP HAI @iTs_DEv_xD",
    "BHOSDIKE",
    "LAAAWEEE KE BAAAAAL",
