...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await idk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await idk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await idk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await idk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await ydk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await ydk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await ydk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await ydk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await wdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await wdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await wdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await wdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await hdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await hdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await hdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await hdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await sdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await sdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await sdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await sdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await adk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await adk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await adk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await adk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await bdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await bdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await bdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await bdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await cdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await cdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await cdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await cdk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await ddk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await ddk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await ddk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await ddk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await edk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await edk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await edk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await edk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await vkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await vkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await vkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await vkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await kkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await kkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await kkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await kkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await lkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await lkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await lkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await lkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await mkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await mkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await mkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await mkk(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await sid(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await sid(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await sid(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await sid(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await shy(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await shy(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await shy(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await shy(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await aan(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await aan(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await aan(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await aan(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await ake(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await ake(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await ake(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await ake(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await eel(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await eel(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await eel(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await eel(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await khu(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await khu(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await khu(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await khu(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await shi(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await shi(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await shi(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await shi(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await yaa(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await yaa(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await yaa(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await yaa(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await dav(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await dav(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await dav(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await dav(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await put(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await put(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await put(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await put(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if tsix:
        ...
        try:
            ...
            await eag(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await eag(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await eag(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await eag(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await eag(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if tseven:
        ...
        try:
            ...
            await gle.start()
            await gle(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await gle(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await gle(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await gle(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await gle(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if teight:
        ...
        try:
            ...
            await wal.start()
            await wal(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await wal(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await wal(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await wal(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await wal(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if tnine:
        ...
        try:
            ...
            await aaa.start()
            await aaa(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await aaa(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await aaa(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await aaa(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await aaa(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
    ...
    if thirty:
        ...
        try:
            ...
            await boy.start()
            await boy(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await boy(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await boy(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await boy(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
            await boy(functions.channels.JoinChannelRequest(channel="@DEV_CHAT_ROOM"))
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 5:
            bio = str(yukki[0])
            text = "𝐃𝐄𝐕 𝐒𝐏𝐀𝐌 𝐁𝐎𝐓 𝐂𝐡𝐚𝐧𝐠𝐢𝐧𝐠 𝐁𝐢𝐨🔥"
            event = await e.reply(text, parse_mode=None, link_preview=None )
            try:
                await e.client(functions.account.UpdateProfileRequest(about=bio))
                await event.edit("【★𝐃𝐄𝐕𝐒★】𝐁𝐢𝐨 𝐂𝐡𝐚𝐧𝐠𝐞𝐝 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲")
            except Exception as e:
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit("【𝗗𝗘𝗩 𝗦𝗣𝗔𝗠 𝗕𝗢𝗧】𝐉𝐨𝐢𝐧𝐞𝐝🔥")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 11:
            ...
            text = "𝗔𝗕 𝗧𝗘𝗥𝗜 𝗠𝗔𝗔 𝐂𝐇𝐎𝐃𝐄𝐍𝐆𝐄 𝗗𝗘𝗩𝗦! "
